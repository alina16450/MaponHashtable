...
{ //theta 1 best case, theta n worst case
	if (size() + 1 >= cap) { 
...
{ //best case theta 1 when elem is first, worst case theta n where we find it at the end, and collisions 
	int i = h(c);
...
{ //best case theta 1 when we find it at beginning, worst case theta n 
	int i = h(c);
